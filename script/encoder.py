...
def main():
    ...
    files = [
        Path(os.path.join(base_dir, file)).as_posix() for file in os.listdir(base_dir)
    ]
    print("=================获取待加密文件=========================")
